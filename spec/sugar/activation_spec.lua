...
describe ("#unit talent contextual activation with syntax sugar,", function ( )
    ...
    it ("should fail when using leaked contextual/subjective element",
    function ( )
        local function scope (self)
            return self
        end
        ...
        local function procedure ( )
            local subject = example.talents.labeled (
    ...
    it ("should fail on subject leaking regardless exceptional failures",
    function ( )
        local subject = nil
    ...
    it ("should generate the same identity for contextual activation",
    function ( )
        ...
        example.talents.labeled (example.target.point, second, assert.equal,
            subject)
    end)

    it ("should fail when accessing a not required/provided property",
    function ( )
